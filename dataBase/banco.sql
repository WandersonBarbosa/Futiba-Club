...
CREATE SCHEMA IF NOT EXISTS `futibaclub` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci ;
USE `futibaclub` ;
...
CREATE  TABLE IF NOT EXISTS `futibaclub`.`groups_users` (
  ...
  `role` VARCHAR(45) NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_groups_users_users` (`user_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `futibaclub`.`guessings` (
  ...
  `user_id` INT NOT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_guessings_games1` (`game_id` ASC) ,
  INDEX `fk_guessings_groups1` (`group_id` ASC) ,
  INDEX `fk_guessings_users1` (`user_id` ASC) ,
...
CREATE  TABLE IF NOT EXISTS `futibaclub`.`comments` (
  ...
  `user_id` INT NOT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `fk_comments_guessings1` (`guessing_id` ASC) ,
